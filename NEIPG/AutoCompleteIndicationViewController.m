...
#import "AutoCompleteIndicationViewController.h"
...
@implementation AutoCompleteIndicationViewController
...
- (void)viewDidLoad {
    ...
    //self.navigationItem.backBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Backdkfasdfjasdf" style:UIBarButtonItemStylePlain target:nil action:nil];
    ...
    [txtField setPlaceholder:@"Enter use here"];
    ...
    UIBarButtonItem *newBackButton = [[UIBarButtonItem alloc] initWithTitle:@"Look Up by Drug" style:UIBarButtonItemStyleBordered target:self action:@selector(home:)];
    //self.navigationItem.leftBarButtonItem=newBackButton;
    
    UIBarButtonItem *flex = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];
    UIBarButtonItem *rightButton = [[UIBarButtonItem alloc] initWithTitle:@"Disclaimer" style:UIBarButtonItemStyleBordered target:self action:@selector(openDisclaimer:)];
    //self.navigationController.toolbarHidden = NO;
    /*UIToolbar *boolbar = [UIToolbar new];
     boolbar.barStyle = UIBarStyleDefault;
     boolbar.tintColor = [UIColor orangeColor];
     [boolbar sizeToFit];*/
    [self setToolbarItems:[NSArray arrayWithObjects:newBackButton,flex,rightButton, nil] animated:YES];
}
...
- (IBAction)openDisclaimer:(id)sender
{
    PGDisclaimerViewController *disclaimerController = [self.storyboard instantiateViewControllerWithIdentifier:@"viewdisclaimer"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[self finishedSearching];
    [self performSegueWithIdentifier:@"showUse" sender:self];
}
...
- (BOOL)shouldPerformSegueWithIdentifier:(NSString *)identifier sender:(id)sender
{
    ...
    if([txtField.text isEqual:(@"Please select an indication.")]) return NO;
...
{
    [[segue destinationViewController] setDrugList:[PGDataManager getDrugNameListByIndication:txtField.text]];
}
